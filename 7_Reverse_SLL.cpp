//Write a program to reverse a singly linked list (BY VALUE only NOT FULL LIST REVERSE) provided that the user will enter the size of node and their values at runtime.....
